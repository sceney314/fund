package com.fund.www.api.base;


import com.fund.www.api.common.Codes;
...
public class BaseResult {
    ...
    public static Result fail(String msg){
        return new FailResult(new Error(Codes.FAIL_CODE, msg));
    }
    ...
    public static <T> Result<T> fail(String message, T data){
        return new FailResult(new Error(Codes.FAIL_CODE, message), data);
    }
