...
public enum AnalyzeTypeEnum {
    ...
    private final static Map<Integer, AnalyzeTypeEnum> MAP_ENUM;
    static {
        MAP_ENUM = Arrays.stream(values()).collect(Collectors.toMap(AnalyzeTypeEnum::getCode, Function.identity()));
    }

    AnalyzeTypeEnum(Integer code, String msg) {
        this.code = code;
        this.msg = msg;
    }

    public static AnalyzeTypeEnum getInstance(Integer code){
